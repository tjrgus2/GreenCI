...
| Job and step names                               | Markdown or HTML injection into the comment and Job Summary               | `escapeMarkdown` on every repository-controlled string; angle brackets, backticks, backslashes, and table pipes neutralized; verified by tests                                                                         |
